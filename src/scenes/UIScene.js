class UIScene extends Phaser.Scene
{
    ...
    create (){
        this.player1_points_text = this.add.bitmapText(gameWidth / 2 - 100, 40, "Pixel", player1_points, 30).setOrigin(1, 0)
        this.player2_points_text = this.add.bitmapText(gameWidth / 2 + 100, 40, "Pixel", player2_points, 30).setOrigin(0, 0)
