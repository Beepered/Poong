class Instruction extends Phaser.Scene {
  ...
  create() {
    this.add
      .bitmapText(gameWidth / 2, 40, "Pixel", "INSTRUCTIONS", 22)
      .setOrigin(0.5)
      .setTintFill(0xff0000);
    this.add
      .bitmapText(gameWidth / 2, 80, "Pixel", "press SPACEBAR for MENU", 20)
      .setOrigin(0.5);

    this.add
      .sprite(gameWidth / 2, gameHeight / 2.5, "instructions")
      .setOrigin(0.5);
    this.add
      .bitmapText(
        gameWidth / 2,
