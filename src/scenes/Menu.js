class Menu extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .bitmapText(260, gameHeight / 2, "Pixel", "PLAY", 25)
      .setOrigin(0, 0.5);
    this.add
      .bitmapText(260, gameHeight / 1.7, "Pixel", "INSTRUCTIONS", 25)
      .setOrigin(0, 0.5);
    this.add
      .bitmapText(260, gameHeight / 1.45, "Pixel", "CREDITS", 25)
      .setOrigin(0, 0.5);

    //instruction
    this.add
      .sprite(150, gameHeight / 1.2, "arrow")
      .setScale(2)
      .setOrigin(0.5)
      .setTintFill(0x000000);
    this.add
      .sprite(190, gameHeight / 1.2, "arrow")
      .setScale(2)
      .setOrigin(0.5)
      .setTintFill(0x000000).flipY = true;
    this.add
      .bitmapText(260, gameHeight / 1.2, "Pixel", "- move", 16)
      .setOrigin(0.5)
      .setTintFill(0x000000);
