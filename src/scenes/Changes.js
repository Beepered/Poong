class Changes extends Phaser.Scene {
  ...
  create() {
    ...
    this.ball_reflection_text = this.add
      .bitmapText(
        gameWidth / 2,
        280,
        "Pixel",
      ...
      .setOrigin(0.5);
    this.fast_ball_text = this.add
      .bitmapText(gameWidth / 2, 310, "Pixel", "50% faster balls: press A", 16)
      .setTintFill(0xff0000)
      .setOrigin(0.5);
    this.increasing_speed_text = this.add
      .bitmapText(
        gameWidth / 2,
        340,
        "Pixel",
      ...
      .setTintFill(0xff0000)
      .setOrigin(0.5);
    this.fast_paddles_text = this.add
      .bitmapText(
        gameWidth / 2,
        370,
        "Pixel",
      ...
      .setTintFill(0xff0000)
      .setOrigin(0.5);
    this.color_balls_text = this.add
      .bitmapText(gameWidth / 2, 400, "Pixel", "weird balls: press Q", 16)
      .setTintFill(0xff0000)
      .setOrigin(0.5);
    this.fast_cooldown_text = this.add
      .bitmapText(
        gameWidth / 2,
        430,
        "Pixel",
    ...
    this.add
      .bitmapText(gameWidth / 2, 490, "Pixel", "press SPACEBAR to play", 25)
      .setOrigin(0.5);
  ...
  update() {
    ...
    if (Phaser.Input.Keyboard.JustDown(keyW)) {
      ...
      fast_cooldown = !fast_cooldown;
      if (fast_cooldown) {
        this.fast_cooldown_text.setTintFill(0x008000);
      } else {
        this.fast_cooldown_text.setTintFill(0xff0000);
      }
    } else if (Phaser.Input.Keyboard.JustDown(this.keyQ)) {
      random_balls = !random_balls;
      if (random_balls) {
        this.color_balls_text.setTintFill(0x008000);
      } else {
        this.color_balls_text.setTintFill(0xff0000);
      }
    }
  }
}
